...
public interface IServiceCenterService
{
    ...
    /// Throws <see cref="QueueLanka.API.Exceptions.ServiceCenterNotFoundException"/> when the
    /// center does not exist, and <see cref="QueueLanka.API.Exceptions.LocationNotFoundException"/>
