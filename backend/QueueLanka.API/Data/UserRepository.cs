...
public class UserRepository : IUserRepository
{
    ...
    {
        const string sql = @"
            SELECT user_id, username, email, password_hash, role, center_id, is_active, created_at
            FROM users
    ...
    {
        const string sql = @"
            INSERT INTO users (username, email, password_hash, role, center_id, is_active, created_at)
            VALUES (@Username, @Email, @PasswordHash, @Role, @CenterId, TRUE, UTC_TIMESTAMP());
