...
| File | Description |
|---|---|
| `sprint-plan.md` | Goals, scope, and Jira tickets for Sprint 1 |
| `scrum-items.md` | Full documentation for all Sprint 1 SCRUM tasks (API contracts, user flows, infrastructure) |
| `daily-standups.md` | Daily standup notes and blockers log |
| `sprint-review.md` | Demo outcome, completed tickets by epic, deferred items, feedback, sprint metrics |
...
| `development-docs/` | Per-ticket dev docs (API contracts, user guides, accessibility review) |
