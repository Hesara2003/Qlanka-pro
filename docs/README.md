...
- **[Branching Strategy](branching-strategy.md)**: Git workflow and branching conventions

## Sprint Documentation

See the [sprints/](sprints/) directory for detailed documentation from each development sprint.</content>
<parameter name="filePath">c:\Users\user\Desktop\Qlanka-pro\docs\README.md