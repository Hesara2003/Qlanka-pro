 ...
 */
export default function CurrentTokenDisplay({ calledToken, loading, error, errorCode }: Props) {
                ...
                <div className="p-8 flex flex-col gap-6 pt-10">
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-black/20 rounded-2xl p-4 border border-gray-800">
                        <div>
                            ...
                            <p className="mt-1 text-white text-sm font-bold">{formatTime(calledToken.calledAt)}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 text-xs font-semibold">Issued Date</p>
                            <p className="mt-1 text-white text-sm font-bold">{formatDate(calledToken.issuedDate)}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 text-xs font-semibold">Issued Time</p>
                            <p className="mt-1 text-white text-sm font-bold">{formatTime(calledToken.issuedTime)}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 text-xs font-semibold">Token ID</p>
                            <p className="mt-1 text-gray-400 text-sm font-bold">#{calledToken.tokenId}</p>
                        </div>
                    </div>
                </div>
            </div>
