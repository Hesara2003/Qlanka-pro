...
export default function CurrentTokenDisplay({
    ...
    const hydratedCalledToken: CalledTokenDto | null = currentToken
        ? {
    ...
    const displayToken = calledToken ?? hydratedCalledToken;
                ...
                <div className="p-8 flex flex-col gap-6 pt-10">
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-black/20 rounded-2xl p-4 border border-gray-800">
                        <div>
                            ...
                            <p className="mt-1 text-white text-sm font-bold">{formatTime(displayToken.calledAt)}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 text-xs font-semibold">Issued Date</p>
                            <p className="mt-1 text-white text-sm font-bold">{formatDate(displayToken.issuedDate)}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 text-xs font-semibold">Issued Time</p>
                            <p className="mt-1 text-white text-sm font-bold">{formatTime(displayToken.issuedTime)}</p>
                        </div>
                        <div>
                            <p className="text-gray-500 text-xs font-semibold">Token ID</p>
                            <p className="mt-1 text-gray-400 text-sm font-bold">#{displayToken.tokenId}</p>
                        </div>
                    </div>
                </div>
            </div>
