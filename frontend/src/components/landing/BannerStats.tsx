...
export default function BannerStats() {
    return (
        <div className="w-full py-16 font-sans relative overflow-hidden border-b border-gray-100 bg-white">
            <div className="max-w-[80rem] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-0 divide-x divide-gray-100">
                    {stats.map((s, i) => (
                        ...
                        >
                            <span className="text-[3rem] md:text-[3.5rem] font-medium text-[#1a1c23] tracking-tighter leading-none">
                            ...
                            <span className="text-gray-400 text-[12px] font-medium uppercase tracking-[0.1em] mt-2">{s.label}</span>
                        </motion.div>
                    ))}
                </div>
            </div>
