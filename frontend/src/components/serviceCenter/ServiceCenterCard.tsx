  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-3 pt-2 flex-wrap">
        ...
        <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-semibold border shrink-0 ${isAvailable ? 'bg-emerald-50 text-emerald-600 border-emerald-100' : 'bg-red-50 text-red-600 border-red-100'}`}>
        ...
        {isAdmin ? (
          <div className="ml-auto flex gap-2 flex-wrap justify-end">
            ...
            <button
              onClick={handleEdit}
              className="px-3 py-2 bg-gray-900 text-white rounded-xl text-[11px] font-semibold hover:bg-black transition-all flex items-center gap-2 shadow-sm whitespace-nowrap"
            >
            ...
            <button
                ...
                className={`ml-auto text-[11px] font-semibold transition-all ${isAvailable ? 'text-gray-900 group-hover:translate-x-1' : 'text-gray-300'}`}
            >
