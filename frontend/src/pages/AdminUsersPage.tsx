    ...
    <>
      <div className="px-10 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h1 className="text-[26px] font-bold text-gray-900 tracking-tight">{t("adminUsers.title")}</h1>
            <p className="text-gray-400 text-[13px] font-bold mt-1 uppercase tracking-widest">{t("adminUsers.subtitle")}</p>
          </div>
          <div className="flex items-center gap-3">
            {!loading && (
              <span className="px-3 py-1.5 bg-emerald-100 text-emerald-600 text-[11px] font-bold rounded-full">
            ...
            <button
              onClick={loadUsers}
              disabled={loading}
              className="bg-black text-white text-xs font-bold px-4 py-2 rounded-full hover:bg-gray-900 transition-colors shadow-sm flex items-center gap-2 disabled:opacity-50"
            >
        ...
        {/* Filter bar */}
        <div className="bg-white rounded-3xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-gray-100 p-4 mb-8 flex flex-col sm:flex-row gap-3">
          {/* Search */}
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 text-sm border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-200 focus:border-transparent transition-all"
            />
          </div>
          ...
          <select
            ...
            className="px-4 py-2 text-sm font-bold text-gray-600 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-200 bg-white"
          >
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Table — desktop */}
            <div className="bg-white rounded-3xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] border border-gray-100 p-6 overflow-hidden hidden sm:block">
              <table className="w-full text-left border-separate border-spacing-y-3">
                <thead>
                  <tr className="text-[12px] font-bold text-gray-400">
                    <th className="px-5 pb-2 tracking-wide font-bold uppercase">{t("adminUsers.table.user")}</th>
                    <th className="px-5 pb-2 tracking-wide font-bold uppercase">{t("adminUsers.table.role")}</th>
                    <th className="px-5 pb-2 tracking-wide font-bold uppercase">{t("adminUsers.table.status")}</th>
                    <th className="px-5 pb-2 tracking-wide font-bold uppercase">{t("adminUsers.table.lastLogin")}</th>
                    <th className="px-5 pb-2 tracking-wide font-bold uppercase">{t("adminUsers.table.joined")}</th>
