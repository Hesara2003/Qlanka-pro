                        ...
                        <div className="grid grid-cols-3 gap-8">
                            ...
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-10 rounded-[2.5rem] border border-gray-50 shadow-sm hover:shadow-premium transition-all">
                                ...
                                <div className="flex items-center justify-between">
                                    <h4 className="text-6xl font-black tracking-tighter text-gray-900" data-testid="officer-waiting-count">{waitingTokens.length}</h4>
                                </div>
                            </motion.div>
                            ...
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-white p-10 rounded-[2.5rem] border border-gray-50 shadow-sm hover:shadow-premium transition-all">
                                ...
                                <div className="flex items-center justify-between">
                                    <h4 className="text-6xl font-black tracking-tighter text-gray-900" data-testid="officer-served-count">{displayStats?.servedCount || 0}</h4>
                                </div>
                            </motion.div>

                            {/* Skipped Card */}
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="bg-white p-10 rounded-[2.5rem] border border-gray-50 shadow-sm hover:shadow-premium transition-all">
                                <div className="flex items-center gap-3 mb-6">
                                    <div className="w-10 h-10 rounded-xl bg-amber-50 flex items-center justify-center text-amber-500">
                                       <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M12 8v4m0 4h.01M10.29 3.86l-8.2 14.21A2 2 0 003.82 21h16.36a2 2 0 001.73-2.93l-8.2-14.21a2 2 0 00-3.42 0z"/></svg>
                                    </div>
                                    <span className="text-sm font-bold text-gray-600">Daily Skipped</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <h4 className="text-6xl font-black tracking-tighter text-gray-900" data-testid="officer-skipped-count">{displayStats?.skippedCount || 0}</h4>
                                </div>
                            </motion.div>
                        </div>
                    </section>
                    ...
                    <section className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-black/[0.02]">
                        ...
                        <AnimatePresence mode="wait">
                            {!calledToken ? (
                                ...
                                >
                                    <div className="bg-gray-50 p-8 rounded-[2rem] text-center mb-4 border border-gray-100 flex flex-col items-center min-h-[200px] justify-center overflow-hidden" data-testid="officer-current-token">
