...
export default function OfficerDashboardPage() {
    ...
    const { latestCalledToken, latestStatusUpdate, connectionStatus } = useQueueHub(officerCenterId);
    ...
    const handleReassignConfirm = useCallback(
        async (targetCounterId: number, reason?: string) => {
            ...
            setSuccessToast(`Token ${selectedToken.tokenNumber} reassigned to ${counterName}`);
